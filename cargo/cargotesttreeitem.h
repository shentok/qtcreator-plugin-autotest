...
class CargoTestTreeItem : public TestTreeItem
{
public:
    explicit CargoTestTreeItem(ITestFramework *framework, const QString &name = QString(), const QString &filePath = QString(),
                            Type type = Root);
...
class CargoTestCodeLocationAndType : public TestCodeLocationAndType
{
public:
    bool m_inherited = false;
};

typedef QVector<CargoTestCodeLocationAndType> CargoTestCodeLocationList;
