...
{
public:
    explicit QtTestTreeItem(QtTestFramework *framework, const QString &name = QString(), const QString &filePath = QString(),
                            Type type = Root);
...
private:
    ...
    mutable QtTestFramework *m_framework = nullptr;
